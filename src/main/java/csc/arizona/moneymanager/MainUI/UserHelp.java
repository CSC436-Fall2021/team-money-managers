...
public class UserHelp extends ServicesView {
    private static Label CREATE_TRANSACTION = new Label("""
    ...
    @Override
    void initContent() {
        Insets titlePadding = new Insets(0, 0, -15, 0);

        Label createTransactionTitle = new Label("To create a transaction");
        createTransactionTitle.setPadding(titlePadding);
        createTransactionTitle.setStyle("-fx-font-weight: bold");

        Label createCategoryTitle = new Label("To create a custom category");
        createCategoryTitle.setPadding(titlePadding);
        createCategoryTitle.setStyle("-fx-font-weight: bold");

        Label createBudgetTitle = new Label("To see the transactions from a certain point in time");
        createBudgetTitle.setPadding(titlePadding);
        createBudgetTitle.setStyle("-fx-font-weight: bold");

        Label createWhatifTitle = new Label("To use What if");
        createWhatifTitle.setStyle("-fx-font-weight: bold");

        content.addRow(1, createTransactionTitle);
        content.addRow(2, CREATE_TRANSACTION);
        content.addRow(3, createCategoryTitle);
        content.addRow(4, CREATE_CATEGORY);
        content.addRow(5, createBudgetTitle);
        content.addRow(6, SETTING_BUDGET);
        // content.addRow(5, REPORT);
        content.addRow(7, createWhatifTitle);
        content.addRow(8, WHAT_IF);
    }
